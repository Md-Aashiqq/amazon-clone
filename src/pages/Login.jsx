...
import { Button } from "../style/LoginSectionStyle";
...
const Login = () => {
  ...
  const handlesubmit = async (data) => {
    ...
    try {
      ...
      return { userData, status: res.status };
    } catch (error) {
        ...
        <Contain>
          ...
          <Box>
            ...
            <Terms>
              ...
              <span>Conditions of Use</span> and Privacy Notice.
            </Terms>
          </Box>
          <Button onClick={() => history.push("/signup")} normal>
            Sign Up
          </Button>
        </Contain>
      </LoginPage>
